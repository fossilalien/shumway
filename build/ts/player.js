    ...
    (function (Remoting) {
        ...
        (function (Player) {
            ...
            var PlayerChannelSerializer = (function () {
                ...
                PlayerChannelSerializer.prototype.writeDecodeImage = function (promiseId, type, data) {
                    writer && writer.writeLn("Sending DecodeImage");
                    this.output.writeInt(107 /* DecodeImage */);
            ...
            var PlayerChannelDeserializer = (function () {
                ...
                PlayerChannelDeserializer.prototype._readAsset = function () {
                ...
                PlayerChannelDeserializer.prototype.read = function () {
                    ...
                    switch (tag) {
                        ...
                        case 108 /* DecodeImageResponse */:
                            return this._readDecodeImageResponse();
                    }
                    release || assert(false, 'Unknown MessageReader tag: ' + tag);
                };
                PlayerChannelDeserializer.prototype._readDecodeImageResponse = function () {
                    var input = this.input;
...
(function (Shumway) {
    ...
    (function (_Player) {
        ...
        var Player = (function () {
            ...
            Player.prototype.processUpdates = function (updates, assets) {
                ...
                switch (message.tag) {
                    ...
                    case 302 /* FocusEvent */:
                        ...
                        break;
                    case 108 /* DecodeImageResponse */:
                        var decodeImageResponseData = message;
            ...
            Player.prototype.decodeImage = function (bitmapSymbol, resolve) {
                release || assert(bitmapSymbol.type === 5 /* PNG */ || bitmapSymbol.type === 6 /* GIF */ || bitmapSymbol.type === 4 /* JPEG */, "No need to decode any other image formats.");
                var output = new DataBuffer();
                var assets = [];
                var serializer = new Shumway.Remoting.Player.PlayerChannelSerializer();
                serializer.output = output;
                ...
                var promiseWrapper = this._pendingPromises[promiseId] = new Shumway.PromiseWrapper();
                promiseWrapper.promise.then(function (decodeImageResponseData) {
