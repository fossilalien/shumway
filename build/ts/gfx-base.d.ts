...
declare module Shumway {
    ...
    class LRUList<T extends ILinkedListNode> {
        ...
        use(node: T): void;
        pop(): T;
        visit(callback: (T: any) => boolean, forward?: boolean): void;
    }
}
declare module Shumway.GFX {
...
declare module Shumway.GFX {
    ...
    class MatrixState extends State {
        ...
        clone(): MatrixState;
        set(state: MatrixState): void;
        free(): void;
    }
    class DirtyNodeVisitor extends NodeVisitor {
        isDirty: boolean;
        private _dirtyRegion;
        start(node: Group, dirtyRegion: DirtyRegion): void;
        visitGroup(node: Group, state: MatrixState): void;
        visitNode(node: Node, state: MatrixState): void;
    }
    ...
    class Renderer extends NodeVisitor {
        ...
        protected _container: HTMLCanvasElement | HTMLDivElement;
        protected _stage: Stage;
        protected _devicePixelRatio: number;
        constructor(container: HTMLCanvasElement | HTMLDivElement, stage: Stage, options: RendererOptions);
        viewport: Rectangle;
        render(): void;
        resize(): void;
...
declare module Shumway.GFX {
    ...
    class Renderable extends Node {
        ...
        _propagateFlagsUp(flags: NodeFlags): void;
        constructor();
        render(context: CanvasRenderingContext2D, ratio: number, cullBounds?: Rectangle, paintClip?: boolean, paintpaintStencil?: boolean): void;
    }
    ...
    class RenderableBitmap extends Renderable {
        ...
        static FromNode(source: Node, matrix: Matrix, colorMatrix: ColorMatrix, blendMode: number, clipRect: Rectangle): RenderableBitmap;
        ...
        render(context: CanvasRenderingContext2D, ratio: number, cullBounds: Rectangle): void;
        drawNode(source: Node, matrix: Matrix, colorMatrix: ColorMatrix, blendMode: number, clip: Rectangle): void;
    ...
    class RenderableText extends Renderable {
        ...
        setContent(plainText: string, textRunData: DataBuffer, matrix: Matrix, coords: DataBuffer): void;
