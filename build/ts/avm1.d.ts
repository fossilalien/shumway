...
declare module Shumway.AVM1 {
    ...
    class AVM1Context {
        ...
        root: AVM1MovieClip;
        loaderInfo: AVM2.AS.flash.display.LoaderInfo;
        globals: AVM1Globals;
        constructor();
        utils: IAVM1RuntimeUtils;
        static create: (loaderInfo: AVM2.AS.flash.display.LoaderInfo) => AVM1Context;
...
declare module Shumway.AVM1.Lib {
    ...
    function initializeAVM1Object(as3Object: any, state: PlaceObjectState): void;
}
declare module Shumway.AVM1.Lib {
    import flash = Shumway.AVM2.AS.flash;
...
declare module Shumway.AVM1.Lib {
    class AVM1Proxy<T> extends AVM2.AS.ASObject {
        private _target;
        constructor();
