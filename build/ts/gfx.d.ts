...
declare module Shumway.GFX.Canvas2D {
    ...
    class MipMap {
        ...
        private _renderer;
        private _surfaceRegionAllocator;
        constructor(renderer: Canvas2DRenderer, node: Node, surfaceRegionAllocator: ISurfaceRegionAllocator, size: number);
    ...
    class Canvas2DRenderer extends Renderer {
        ...
        private _fontSize;
        private _layers;
        constructor(container: HTMLCanvasElement | HTMLDivElement, stage: Stage, options?: Canvas2DRendererOptions);
        ...
        private _renderToTemporarySurface(node, state, clip);
        private _allocateSurface(w, h);
...
declare module Shumway.Remoting.GFX {
    ...
    class GFXChannelSerializer {
        ...
        writeDecodeImageResponse(promiseId: number, type: ImageType, data: Uint8Array, width: number, height: number): void;
    ...
    class GFXChannelDeserializerContext implements IVideoPlaybackEventSerializer {
        ...
        _decodeImage(type: ImageType, data: Uint8Array, oncomplete: (imageData: ImageData) => void): void;
...
declare module Shumway.GFX {
    ...
    class EaselHost {
        ...
        onSendUpdates(update: DataBuffer, asssets: DataBuffer[]): void;
        easel: Easel;
        stage: Stage;
        content: Group;
        cursor: string;
        ...
        processUpdates(updates: DataBuffer, assets: DataBuffer[], output?: DataBuffer): void;
        processExternalCommand(command: any): void;
        processVideoControl(id: number, eventType: VideoControlEvent, data: any): any;
        processFSCommand(command: string, args: string): void;
        processFrame(): void;
        onExernalCallback(request: any): void;
...
declare module Shumway.GFX.Window {
    ...
    class WindowEaselHost extends EaselHost {
        ...
        onSendUpdates(updates: DataBuffer, assets: DataBuffer[]): void;
        onExernalCallback(request: any): void;
        onDisplayParameters(params: DisplayParameters): void;
        onVideoPlaybackEvent(id: number, eventType: VideoPlaybackEvent, data: any): void;
