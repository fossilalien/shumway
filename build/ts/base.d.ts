...
declare module Shumway.ArrayUtilities {
    class Inflate {
        ...
        private _buffer;
        private _bufferSize;
        private _bufferPosition;
        private _bitBuffer;
        private _bitLength;
        private _window;
        private _windowPosition;
        private _state;
        private _isFinalBlock;
        private _literalTable;
        private _distanceTable;
        private _block0Read;
        private _block2State;
        private _copyState;
        private _error;
        error: any;
        constructor(verifyHeader: boolean);
        push(data: Uint8Array, takeOwnership?: boolean): void;
        private _verifyZlibHeader();
        private _decodeInitState();
        private _decodeBlock0();
        private _readBits(size);
        private _readCode(codeTable);
        private _decodeBlock2Pre();
        private _decodeBlock();
