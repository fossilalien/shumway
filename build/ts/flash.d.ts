...
declare module Shumway.Timeline {
    ...
    class AnimationState {
        ...
        events: any[];
        variableName: string;
        constructor(symbolId: number, symbol?: DisplaySymbol, depth?: number, matrix?: flash.geom.Matrix, colorTransform?: flash.geom.ColorTransform, ratio?: number, name?: string, clipDepth?: number, filters?: any[], blendMode?: string, cacheAsBitmap?: boolean, visible?: boolean, events?: any[], variableName?: string);
    ...
    class FrameDelta {
        private loaderInfo;
        private commands;
        private _stateAtDepth;
        private _soundStarts;
        private _soundStreamHead;
        private _soundStreamBlock;
        stateAtDepth: Map<AnimationState>;
...
declare module Shumway.AVM2.AS.flash.display {
    ...
    class DisplayObject extends events.EventDispatcher implements IBitmapDrawable, Remoting.IRemotable {
        ...
        static classSymbols: string[];
        static instanceSymbols: string[];
        createAnimatedDisplayObject(state: Timeline.AnimationState, callConstructor: boolean): DisplayObject;
        ...
        _animate(state: Timeline.AnimationState): void;
...
declare module Shumway.AVM2.AS.flash.display {
    ...
    class ButtonSymbol extends Timeline.DisplaySymbol {
        upState: Timeline.AnimationState;
        overState: Timeline.AnimationState;
        downState: Timeline.AnimationState;
        hitTestState: Timeline.AnimationState;
        loaderInfo: LoaderInfo;
...
declare module Shumway.AVM2.AS.flash.display {
    ...
    class BitmapSymbol extends Timeline.DisplaySymbol {
        width: number;
        height: number;
        image: any;
        data: Uint8Array;
...
declare module Shumway.AVM2.AS.flash.display {
    ...
    class LoaderInfo extends events.EventDispatcher {
        ...
        getFrame(sprite: {
            ...
            labelName: string;
            soundStreamHead: SWF.Parser.SoundStream;
            soundStreamBlock: Uint8Array;
            actionBlocks: Uint8Array[];
            initActionBlocks: SWF.InitActionBlock[];
            exports: SWF.SymbolExport[];
            frameDelta: Timeline.FrameDelta;
        };
...
declare module Shumway.AVM2.AS.flash.text {
    class Font extends ASNative implements Remoting.IRemotable {
        ...
        static registerLazyFont(fontMapping: {
            name: string;
            id: number;
        }, loaderInfo: display.LoaderInfo): void;
        static resolveLazyFont(loaderInfo: display.LoaderInfo, id: number): Font;
        fontName: string;
        fontStyle: string;
        fontType: string;
        hasGlyphs(str: string): boolean;
    }
    class FontSymbol extends Timeline.Symbol {
        name: string;
        id: number;
        bold: boolean;
        italic: boolean;
