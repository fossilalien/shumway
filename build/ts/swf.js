    ...
    (function (SWF) {
        ...
        var SWFFile = (function () {
                ...
                while (stream.pos < spriteTagEnd) {
                    ...
                    switch (tagCode) {
                        ...
                        case 43 /* CODE_FRAME_LABEL */:
                            ...
                            break;
                        case 1 /* CODE_SHOW_FRAME */:
                            frames.push(new SWFFrame(label, commands, soundStreamHead, soundStreamBlock, actionBlocks, initActionBlocks, null));
                            label = null;
                            commands = [];
            ...
            SWFFile.prototype.finishFrame = function () {
                ...
                this.frames.push(new SWFFrame(this._currentFrameLabel, this._currentDisplayListCommands, this._currentSoundStreamHead, this._currentSoundStreamBlock, this._currentActionBlocks, this._currentInitActionBlocks, this._currentExports));
                this._currentFrameLabel = null;
                this._currentDisplayListCommands = null;
                this._currentSoundStreamHead = null;
                this._currentSoundStreamBlock = null;
            ...
            SWFFile.prototype.decodeEmbeddedFont = function (unparsed) {
                ...
                var promise = new Promise(function (resolve, reject) { return setTimeout(resolve, 400); });
                promise.then(this.markSymbolAsDecoded.bind(this, symbol));
                var currentPromise = this.pendingSymbolsPromise;
                this.pendingSymbolsPromise = currentPromise ? Promise.all([currentPromise, promise]) : promise;
            };
            ...
            SWFFile.prototype.markSymbolAsDecoded = function (symbol, event) {
                symbol.ready = true;
                if (!release && SWF.traceLevel.value > 0) {
                    console.info("Marking symbol " + symbol.id + " as decoded.", symbol);
                }
                if (event && event.type === 'error') {
                    Shumway.Debug.warning("Decoding of image symbol failed", symbol, event);
                }
            };
            return SWFFile;
        })();
        SWF.SWFFile = SWFFile;
        function decodeImage(definition, oncomplete) {
        ...
        var SWFFrame = (function () {
            function SWFFrame(labelName, commands, soundStreamHead, soundStreamBlock, actionBlocks, initActionBlocks, exports) {
...
(function (Shumway) {
    ...
    var ImageFile = (function () {
        ...
        ImageFile.prototype.processLoadedData = function () {
        ...
        ImageFile.prototype.decodeImage = function () {
...
(function (Shumway) {
    ...
    var LoadProgressUpdate = (function () {
        function LoadProgressUpdate(bytesLoaded) {
    ...
    var FileLoader = (function () {
        ...
        FileLoader.prototype.processNewData = function (data, progressInfo) {
            ...
            if (file instanceof SWFFile) {
                ...
                if (progressInfo.bytesLoaded === progressInfo.bytesTotal) {
                    file.decodingPromise.then(this._listener.onLoadComplete.bind(this._listener));
                }
            }
        };
        ...
        FileLoader.prototype.processSWFFileUpdate = function (file) {
