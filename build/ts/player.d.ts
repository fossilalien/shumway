...
declare module Shumway.Remoting.Player {
    ...
    class PlayerChannelSerializer {
        ...
        writeDecodeImage(promiseId: number, type: ImageType, data: Uint8Array): void;
    }
    interface DecodeImageResponseData {
        promiseId: number;
        type: ImageType;
        data: Uint8Array;
        width: number;
    ...
    class PlayerChannelDeserializer {
        ...
        private _readAsset();
        read(): any;
        private _readDecodeImageResponse();
...
declare module Shumway.Player {
    ...
    class Player implements IBitmapDataSerializer, IFSCommandListener, IVideoElementService {
        private _stage;
        private _loader;
        private _loaderInfo;
        ...
        decodeImage(bitmapSymbol: flash.display.BitmapSymbol, resolve: (result: any) => void): void;
